...
def parse_database_url(database_url: str) -> dict:
    ...
    db_config = {
        ...
        # Exact origins for credentialed browser requests. Do not use '*'.
...
>>>>>>> 2b9fca2c06855fc9f00d6ad58b258e7bb6aa9e30
    ],
}
...
<<<<<<< HEAD
# Use exact frontend origins for credentialed browser requests. Do not allow wildcards.
...
for origin in DEFAULT_FRONTEND_ORIGINS:
    if origin not in FRONTEND_ORIGINS:
        FRONTEND_ORIGINS.insert(0, origin)
...
# Enforce secure cookie attributes when not in DEBUG
